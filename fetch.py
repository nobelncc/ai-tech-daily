...
def main():
    ...
    # Group by category and interleave (round-robin) so every category gets
    # a fair share of each run's AI-summary budget, instead of the
    # first-listed category using it all up.
    by_category = {}
